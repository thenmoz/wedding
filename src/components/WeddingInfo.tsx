    ...
    <div className="bg-[#E3CAA5] flex items-center justify-center py-4">
      ...
      <div className="w-full p-10 relative mr-1">
        ...
        <div className="text-center mb-8">
          <p className="text-20 sm:text-32 font-lustria text-[#6C4E31]">30 . 11 . 2024</p>
          <p className="text-14 sm:text-20 font-libreCaslon text-[#6C4E31]">at Kensington English Garden</p>
          <p className="text-14 sm:text-20 font-libreCaslon text-[#6C4E31]">Resort Khaoyai</p>
          <p className="text-14 sm:text-20 font-libreCaslon text-[#6C4E31] mt-6"> 17:30 P.M.</p>
        </div>

        {/* Theme Section */}
        <div className="text-center">
          <p className="text-13 sm:text-20 font-semibold font-libreCaslon text-[#705538] mb-2">DRESS CODE</p>
